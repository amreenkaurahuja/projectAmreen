...
- **Educational Sequencing** — reasons about the order and pacing of educational content across time, operating on educational policies rather than deriving educational meaning directly from learner evidence.
...
- A future proposal to collapse Interpretation back into Policy, or to bypass Sequencing by embedding sequencing decisions within Policy, is a change to an architectural invariant recorded here and in DDS-001's worked examples, not a routine implementation choice — it should be evaluated against the evidence in ACB-001 §3.3 and §3.5, not re-derived from scratch.
