...
- `promptVersion` (currently `"coach-v1"`) is part of the DTO and is stored alongside every cached response; a future wording change ships as `coach-v2` rather than mutating the existing version (see `docs/AI_CONSTITUTION.md`, Rule 11).
